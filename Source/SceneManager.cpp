...
void SceneManager::LoadSceneTextures() {
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/mattwhite.jpg",
		"floor");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/blackMesh.jpg",
		"mesh"
	);
	bReturn = CreateGLTexture(
...
void SceneManager::RenderScene()
{
	...
	/////////////////////////////////////////////////////// Water Bottle ///////////////////////////////////////////////////////
	//bottle body
	glm::vec3 cylinderScale = glm::vec3(1.5f, 6.0f, 1.5f); // Example size
	float cylinderYrotationDegrees = 0.0f;
	glm::vec3 cylinderPosition = glm::vec3(-3.0f, 0.0f, 0.0f); // Offset to the left
	SetTransformations(cylinderScale, 0.0f, cylinderYrotationDegrees, 0.0f, cylinderPosition);
	...
	float coneYrotationDegrees = 0.0f;
	glm::vec3 conePosition = glm::vec3(-3.0f, 6.0f, 0.0f); // Position to the right
	SetTransformations(coneScale, 0.0f, coneYrotationDegrees, 0.0f, conePosition);
	SetShaderColor(0.635f, 0.635f, 0.635f, 0.5f);

	m_basicMeshes->DrawConeMesh(true);

	//Bottle tip
	glm::vec3 secondCylinderScale = glm::vec3(1.0f, 0.3f, 1.0f);
	float secondCylinderYRotationDegrees = 0.0f;
	glm::vec3 secondCylinderPosition = glm::vec3(-3.0f, 6.5f, 0.0f);
	SetTransformations(secondCylinderScale,0.0f,secondCylinderYRotationDegrees,0.0f,secondCylinderPosition);
	SetShaderColor(0.2f, 0.2f, 0.2f, 1.0f);
	m_basicMeshes->DrawCylinderMesh();
	
	//BOTTLE CAP
	glm::vec3 thinCylinderScale = glm::vec3(1.0f, 0.7f, 1.0f);           // Emphasizes thinness
	float thinCylinderYRotationDegrees = 0.0f;
	glm::vec3 thinCylinderPosition = glm::vec3(-3.0f, 6.8f, 0.0f);   // More descriptive 
	SetTransformations(thinCylinderScale,0.0f,thinCylinderYRotationDegrees,0.0f,thinCylinderPosition);
	// Set the color (dark grey)
	...
	///////////////////////////////////////////////////////speakers///////////////////////////////////////////////////////
	// 
	glm::vec3 cubeScale = glm::vec3(4.0f, 4.0f, 4.0f); // Adjust size as needed
	float cubeYrotationDegrees = 0.0f; // Feel free to add rotation
	glm::vec3 cubePosition = glm::vec3(2.0f, 2.0f, -1.52f); // Offset to the right of the bottle
	SetTransformations(cubeScale, 0.0f, cubeYrotationDegrees, 0.0f, cubePosition);
	//SetShaderColor(0.933f, 0.871f, 0.745f, 1.0f);
	...
	//speaker mesh
	glm::vec3 speakerMesh = glm::vec3(1.5f, 1.5f, 1.5f);
	float coneYrotationDegrees1 = 50.0f;
	glm::vec3 speakerMeshPos = glm::vec3(2.0f, 2.0f, 0.5f); // You'll need to fill this in
	SetTransformations(speakerMesh, -90.0f, coneYrotationDegrees1, 0.0f, speakerMeshPos);
	SetShaderTexture("mesh");
	m_basicMeshes->DrawConeMesh(true);
	//speaker hole
	// 
	//speaker hole
	glm::vec3 speakerHole = glm::vec3(0.4f, 0.15f, 0.4f);
	float sphereYrotationDegrees1 = 0.0f;
	glm::vec3 speakerMeshHolePos = glm::vec3(2.0f, 2.0f, 0.5f); // You'll need to fill this in
	SetTransformations(speakerHole, -90.0f, sphereYrotationDegrees1, 0.0f, speakerMeshHolePos);
	SetShaderColor(0.2f, 0.2f, 0.2f, 1.0f);
